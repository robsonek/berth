...
func TestOffsiteValidate(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "keep-last-valid", offsite: mutS3(func(o *Offsite) { o.Keep = OffsiteKeep{Last: 12} })},
		{name: "keep-hourly-valid", offsite: mutS3(func(o *Offsite) { o.Keep = OffsiteKeep{Hourly: 24} })},
		{name: "keep-last-and-hourly-valid", offsite: mutS3(func(o *Offsite) { o.Keep = OffsiteKeep{Last: 12, Hourly: 24} })},
		{name: "keep-last-out-of-range", offsite: mutS3(func(o *Offsite) { o.Keep = OffsiteKeep{Last: 4000} }), wantErr: "backups.offsite.keep.last"},
		{name: "keep-hourly-out-of-range", offsite: mutS3(func(o *Offsite) { o.Keep = OffsiteKeep{Hourly: -1} }), wantErr: "backups.offsite.keep.hourly"},
