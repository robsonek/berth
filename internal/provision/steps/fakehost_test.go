...
func contractServer(t *testing.T) *config.Server {
	...
	// workstation cache. Modelling their ABSENCE instead would make
	...
	// The values are the ones the modelled /etc/berth/offsite.env carries,
	// so a healthy host agrees with its cache.
